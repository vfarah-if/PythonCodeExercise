...
from src.clean_architecture_example.infrastructure.repositories.in_memory_user_repository import InMemoryUserRepository
from src.clean_architecture_example.infrastructure.repositories.file_user_repository import FileUserRepository
...
class TestInMemoryUserRepository:
    ...
    async def test_get_all_users(self, repository):
        ...
        # Arrange
        user1 = User(email=Email("user1@example.com"), first_name="User", last_name="One")
        user2 = User(email=Email("user2@example.com"), first_name="User", last_name="Two")
    ...
    def test_helper_methods(self, repository):
        ...
        async def test_helpers():
            user1 = User(email=Email("test1@example.com"), first_name="Test", last_name="One")
            user2 = User(email=Email("test2@example.com"), first_name="Test", last_name="Two")
...
class TestFileUserRepository:
    ...
    async def test_multiple_users_file_operations(self, repository):
        ...
        users = [
            User(email=Email(f"user{i}@example.com"), first_name=f"User{i}", last_name="Test")
            for i in range(3)
        ]
