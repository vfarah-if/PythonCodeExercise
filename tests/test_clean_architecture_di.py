...
from src.clean_architecture_example.shared.di.container import DIContainer, ServiceLifetime
...
class TestDIContainer:
    ...
    def test_circular_dependency_detection(self, container):
        ...
        def create_service_a(c: DIContainer):
            service_b = c.resolve(ServiceB)  # This will cause circular dependency
            return ServiceImpl()
...
class TestServiceDescriptor:
    ...
    def test_service_descriptor_creation(self):
        ...
        # Test with factory
        def factory(c): return ServiceImpl()
