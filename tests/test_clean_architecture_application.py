...
from src.clean_architecture_example.application.use_cases.create_user_use_case import CreateUserUseCase
from src.clean_architecture_example.application.use_cases.get_user_use_case import GetUserUseCase
from src.clean_architecture_example.application.use_cases.update_user_use_case import UpdateUserUseCase
...
class TestCreateUserUseCase:
    ...
    @pytest.mark.asyncio
    async def test_create_user_with_existing_email_fails(self, use_case, mock_repository):
    ...
    @pytest.mark.asyncio
    async def test_create_user_with_invalid_email_fails(self, use_case, mock_repository):
...
class TestGetUserUseCase:
    ...
    @pytest.mark.asyncio
    async def test_get_user_by_email_success(self, use_case, mock_repository, sample_user):
...
class TestUpdateUserUseCase:
    ...
    @pytest.mark.asyncio
    async def test_update_user_name_success(self, use_case, mock_repository, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_update_user_partial_update(self, use_case, mock_repository, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_update_user_with_invalid_name(self, use_case, mock_repository, sample_user):
